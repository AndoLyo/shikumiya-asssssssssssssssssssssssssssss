  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: "linear-gradient(to top, rgba(26,26,26,0.9) 0%, rgba(26,26,26,0.4) 40%, transparent 100%)",
        }}
      >
      ...
      <div
        className="absolute top-0 right-0 w-16 h-16 opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none"
        style={{
      ...
      <div className="mx-auto max-w-6xl">
          ...
          <motion.h2
            ...
            animate={{
              textShadow: [
                ...
                "3px 3px 12px rgba(230,57,70,0.3)",
                "3px 3px 0 rgba(26,26,26,0.12)",
              ],
            }}
        ...
        {hasDataWorks && (
          <motion.div
            ...
            animate={{
              boxShadow: [
                "8px 8px 0 var(--cp-border)",
                "8px 8px 20px rgba(255,193,7,0.15)",
                "8px 8px 0 var(--cp-border)",
              ],
            }}
          >
          ...
          <motion.a
            ...
            animate={{
              boxShadow: [
                ...
                "5px 5px 12px rgba(255,193,7,0.3)",
                "5px 5px 0 var(--cp-border)",
              ],
            }}
